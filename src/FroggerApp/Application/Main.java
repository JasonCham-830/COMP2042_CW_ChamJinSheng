...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		BackgroundImage froggerback = new BackgroundImage("file:src/FroggerApp/Images_File/Screen Shot 2017-05-29 at 10.02.14 PM.png");
		...
		//background.add(new Log("file:src/FroggerApp/Images_File/logs.png", 300, 800, 276, -2));
		...
		//background.add(new Log("file:src/FroggerApp/Images_File/log3.png", 150, 570, 329, 0.75));
		...
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 100, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 0, 100, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 120, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 120, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 140, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 140, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 160, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 300, 160, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 180, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 180, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 200, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 200, -1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 100, 220, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 200, 220, 1));
		//background.add(new Log("file:src/FroggerApp/Images_File/log2.png", 400, 220, 1));
		//End end2 = new End();
		//End end3 = new End();
		//End end4 = new End();
		//End end5 = new End();
